...
<head>
    ...
    <title>{{ \App\Models\Setting::getValue('app_name', config('app.name', 'Church')) }}</title>
        ...
        <div class="relative z-10">
            <nav class="flex items-center justify-between px-6 py-3 max-w-7xl mx-auto">
                <div class="flex items-center gap-3">
                    @if($logo)
                        <img src="{{ Storage::disk('public')->url($logo) }}" alt="{{ $appName }}" class="h-10 w-10 rounded-full object-cover">
                    @else
                ...
                <div class="flex items-center gap-4">
                    ...
                    @else
                        ...
                        <a href="{{ url('/admin') }}" class="btn-primary">Get Started</a>
                    @endauth
                </div>
            </nav>
                    ...
                    <div class="carousel-slide {{ $index === 0 ? 'active' : '' }}">
                        ...
                        <div class="carousel-overlay">
                            <div class="carousel-content animate-fade-in">
                                ...
                                @if($slide->link)
                                    <a href="{{ $slide->link }}" class="btn-primary">Learn More</a>
                                @else
                                    <a href="{{ url('/admin') }}" class="btn-primary">Join Us This Sunday</a>
                                @endif
                            </div>
                        </div>
                    </div>
    ...
    <div class="stats-section">
        <div class="max-w-7xl mx-auto">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div class="stat-card">
                    <div class="stat-number">{{ $ministryCount }}</div>
                    <div class="text-blue-200 mt-2">Ministries</div>
                </div>
                <div class="stat-card">
                    <div class="stat-number">{{ $bibleStudyGroupCount }}</div>
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="feature-card">
                    ...
                    <p class="text-gray-600">{{ Str::limit($ministry->description, 80) ?: 'Join us in fellowship and service' }}</p>
                </div>
                @empty
                <div class="feature-card">
                    <div class="feature-icon">
        ...
        <div class="max-w-4xl mx-auto px-8 text-center text-white">
            ...
            <div class="service-times max-w-md mx-auto">
                ...
                <div class="service-time-item">
                    <span class="font-semibold">{{ $service['day'] }} - {{ $service['name'] }}</span>
                    <span class="text-blue-200">{{ $service['time'] }}</span>
                </div>
                @endforeach
            </div>
        </div>
    ...
    <div class="features-section">
        <div class="max-w-4xl mx-auto text-center">
            ...
            <p class="text-xl text-gray-600 mb-8">
                {{ $description ?: "We'd love to welcome you to our church family. Join us for worship, fellowship, and encouragement." }}
            </p>
            <div class="bg-blue-50 rounded-2xl p-8 inline-block">
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <span class="text-lg text-gray-700">{{ $address }}{{ $city ? ', ' . $city : '' }}</span>
                </div>
                @if($phone)
                <div class="flex items-center gap-3 mb-4">
                    <svg class="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                @endif
                <a href="{{ url('/admin') }}" class="btn-primary">Plan Your Visit</a>
            </div>
        </div>
    </div>

    <div class="footer">
        <p class="text-gray-400">&copy; {{ date('Y') }} {{ $appName }}. All rights reserved.</p>
